...
function Header({ itemCount, onCartClick }) {
  ...
  return (
    <header className=" z-50 bg-gray-100 dark:bg-slate-900  pt-2 w-full md:bg-transparent top-0 left-0 right-0">
      <nav className="lg:px-14 p-4 bg-gray-100 dark:bg-slate-900 z-50  top-0 left-0 right-0 fixed border-b duration-200">
