      ...
      <div className="bg-gray-800 text-white rounded-lg shadow-lg max-w-4xl w-full p-6 sm:p-8">
        ...
        {bookData.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="col-span-1 bg-gray-700 rounded-lg p-4 sm:p-6">
              ...
              <div className="flex justify-between mb-2">
                ...
                <span>
                  $
                  {bookData.reduce((acc, item) => acc + item.price * item.quantity, 0)}
                </span>
              </div>
              <div className="flex justify-between mb-2">
                <span>Shipping</span>
          ...
          <div className="flex flex-col items-center justify-center py-10">
            <p className="text-gray-400 text-lg sm:text-xl">No items in your cart.</p>
            <button
              onClick={onClose}
              className="mt-4 bg-blue-600 hover:bg-blue-500 text-white py-2 px-6 rounded-lg"
            >
              Close
            </button>
          </div>
